...
const timeSlots = [
  "09:00 AM", "10:00 AM", "11:00 AM", "01:00 PM", "02:00 PM", "03:00 PM", "04:00 PM", "07:00 PM", "08:00 PM"
];

const DoctorDetailCard = ({ doctor, selectedDate, onDateChange, selectedTime, onTimeChange, onBook }) => {
  return (
    <Box p={2}>
      <Box display="flex" alignItems="center" gap={2}>
        ...
        <Box>
          ...
          <Box display="flex" alignItems="center" gap={1}>
            ...
            <Typography variant="body2" color="textSecondary">{doctor.distance}</Typography>
          </Box>
        </Box>
      </Box>
